# Created By  : P. Kulkarni
# Company : Electric Power Research Institute
# version : 1.0

'''
This is a script to strip all the EXIF information contained in an image.

Workflow:
1. Read images from a directory
2. Extract exif/metadata and write to a csv
3. Save a copy of image without having the metadata associated to it. This also reduces the image size.
